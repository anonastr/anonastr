...
3. **🧹 Dust Sweeper**: Got random pennies of ASTER stuck across multiple burner wallets? Sweep it all into one wallet in a single click.
...
This project runs on React + Vite.
